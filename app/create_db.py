...
def default_values():
	...
	data_source = [
		...
		{'param': 'haproxy_deployment_mode', 'value': 'both', 'section': 'change_center', 'desc': 'Configuration deployment mode for HAProxy', 'group_id': '1'},
		{'param': 'nginx_deployment_mode', 'value': 'both', 'section': 'change_center', 'desc': 'Configuration deployment mode for NGINX', 'group_id': '1'},
		{'param': 'apache_deployment_mode', 'value': 'both', 'section': 'change_center', 'desc': 'Configuration deployment mode for Apache', 'group_id': '1'},
		{'param': 'keepalived_deployment_mode', 'value': 'both', 'section': 'change_center', 'desc': 'Configuration deployment mode for Keepalived', 'group_id': '1'},
