...
def default_values():
	data_source = [
		...
		{'param': 'proxy', 'value': '', 'section': 'main', 'desc': 'Proxy server. Use proto://ip:port', 'group': '1'},
		...
		{'param': 'tmp_config_path', 'value': '/tmp/', 'section': 'main',
		 'desc': 'Temp store configs, for check. Path must exist', 'group': '1'},
		...
		{'param': 'ssl_local_path', 'value': 'certs', 'section': 'main',
		 'desc': 'Path to dir for local save SSL certs. This is a relative path, begins with $HOME_ROXY-WI/app/',
		 'group': '1'},
		{'param': 'lists_path', 'value': 'lists', 'section': 'main',
		 'desc': 'Path to black/white lists. This is a relative path, begins with $HOME_ROXY-WI',
		 'group': '1'},
		{'param': 'local_path_logs', 'value': '/var/log/haproxy.log', 'section': 'logs',
		 'desc': 'Logs save locally, enabled by default', 'group': '1'},
		{'param': 'syslog_server_enable', 'value': '0', 'section': 'logs',
		 'desc': 'If exist syslog server for HAProxy logs, enable this option', 'group': '1'},
		{'param': 'log_time_storage', 'value': '14', 'section': 'logs',
		 'desc': 'Storage time for user activity logs, in days', 'group': '1'},
		...
		{'param': 'haproxy_sock_port', 'value': '1999', 'section': 'haproxy', 'desc': 'HAProxy sock port',
		 'group': '1'},
		{'param': 'apache_log_path', 'value': '/var/log/httpd/', 'section': 'logs', 'desc': 'Path to Apache logs folder',
		 'group': '1'},
		...
		{'param': 'ldap_enable', 'value': '0', 'section': 'ldap', 'desc': 'If 1 ldap enabled', 'group': '1'},
		{'param': 'ldap_server', 'value': '', 'section': 'ldap', 'desc': 'IP address ldap server', 'group': '1'},
		{'param': 'ldap_port', 'value': '389', 'section': 'ldap', 'desc': 'Default port: 389 or 636', 'group': '1'},
		{'param': 'ldap_user', 'value': '', 'section': 'ldap',
		 'desc': 'Login to connect to LDAP server. Format: user@domain.com', 'group': '1'},
		...
		{'param': 'ldap_domain', 'value': '', 'section': 'ldap',
		 'desc': 'Domain for login, like user@domain.com, without user@', 'group': '1'},
		...
		{'param': 'ldap_user_attribute', 'value': 'sAMAccountName', 'section': 'ldap',
		 'desc': 'User attribute for searching', 'group': '1'},
...
def update_db_v_4_5_9(**kwargs):
	data_source = [
		{'param': 'smon_check_interval', 'value': '1', 'section': 'monitoring', 'desc': 'SMON check interval, in minutes',
		 'group': '1'},
		{'param': 'checker_check_interval', 'value': '1', 'section': 'monitoring',
		 'desc': 'Checker check interval, in minutes', 'group': '1'},
		{'param': 'port_scan_interval', 'value': '5', 'section': 'monitoring',
		 'desc': 'Port scanner check interval, in minutes', 'group': '1'},
	]
